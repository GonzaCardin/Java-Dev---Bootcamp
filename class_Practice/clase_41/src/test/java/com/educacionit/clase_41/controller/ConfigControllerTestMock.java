...
@ExtendWith(MockitoExtension.class) // Cuando se hace mvc se utiliza @SpringBootTest, cuando hacer mockeo se utiliza @ExtendWith(MockitoExtension.class) //
public class ConfigControllerTestMock {
    @Mock
    ...
    @Test
    void testGetConfig() {
        when(mockConfig.getNombre_1()).thenReturn("VARIABLE_1");
        when(mockConfig.getNombre_2()).thenReturn("VARIABLE_2");
